    ...
    <div class="row">
        ...
        <div class="col-lg-2">
            <ul class="nav nav-pills nav-stacked">
                ...
                <li class="active"><a href="${pageContext.request.contextPath}/student/completeCourse">已修课程<span
        ...
        <div class="col-lg-10">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div style="display: inline-block; font-weight: normal; font-size: xxx-large">已修课程</div>
                </div>
