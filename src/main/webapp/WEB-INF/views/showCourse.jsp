    ...
    <div class="row">
        ...
        <div class="col-lg-2">
            <ul class="nav nav-pills nav-stacked">
                ...
                <li><a href="#">学生管理<span class="badge pull-right">8</span></a></li>
                <li><a href="#">教师管理<span class="badge pull-right">8</span></a></li>
        ...
        <div class="col-lg-10">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div style="display: inline-block; font-weight: normal; font-size: xxx-large">课程名单管理</div>
                    <div class="btn-toolbar pull-right" role="toolbar"
                        ...
                        <div class="btn-group" role="group">
                            <button type="button" class="btn btn-default">添加课程信息<i class="fa-solid fa-plus"></i>
                            </button>
                        </div>
                    </div>
                </div>
